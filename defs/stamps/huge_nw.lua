...
local function UpdateAdjacencyData(self, x, y, bookSelf, bonusDisplayTable, left, right, top, bottom, ne, nw, sw, se)
	if (OtherMatches(right, "huge_ne") and OtherMatches(se, "huge_ne") and OtherMatches(bottom, "huge_ne")) or true then
...
local function GetSoloScore(self)
	local score = (self.rarity + 1) * self.quality + self.rarity + 15
